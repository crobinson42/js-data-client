...
},{}],"node_modules/js-data-http/dist/js-data-http.js":[function(require,module,exports) {
var define;
var global = arguments[3];
...
},{"js-data":"node_modules/js-data/dist/js-data.js","process":"node_modules/process/browser.js"}],"index.js":[function(require,module,exports) {
"use strict";

var _jsData = require("js-data");

var _jsDataHttp = require("js-data-http");
...
var adapter = new _jsDataHttp.HttpAdapter({
  // node.js dev server
...
store.defineMapper('user', {
  setThisUser: function setThisUser(user) {
    this.thisUser = user;
  }
});
